...
path="/Users/majiefeng/Desktop/研究生课程/数据挖掘/homework_jfma/个贷违约预测/train_dataset"

train_bank = pd.read_csv(path+'/train_public.csv')
train_internet = pd.read_csv(path+'/train_internet.csv')
train_bank
